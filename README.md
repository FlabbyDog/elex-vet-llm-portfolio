...
- **LLMs & Prompt Engineering** – designing tasks, prompt chains, and evaluation rubrics  
- **Data Annotation & Analytics** – extracting structured data from messy transcripts and computing performance metrics  
- **Veterinary Practice Support** – phone communication, clinical documentation, client education, and reception workflows  

I’m currently looking for roles such as:
- AI Trainer / LLM Evaluator / Data Annotator  
- Prompt Engineer (especially domain-specific)  
- Veterinary Healthcare Virtual Assistant (VHVA) with AI/LLM tooling
...
- **LLMs & Prompting**
  - Task design, multi-step prompt chains, meta-prompts
  - Model comparison and evaluation (structure, hallucinations, tone, cost)
  - Designing output schemas for downstream code (JSON, tables, reports)

- **Data & Analytics**
  - Information extraction from call transcripts
  - Scoring schemes and rubrics for communication skills
  - Google Sheets + basic stats + dashboards
  - Supabase as a structured data store

- **Tooling & Implementation**
  - Google Apps Script [JS-based automation for Google Workspace]
  - Python (Google Colab, simple backend scripts)
  - Basic HTML/JavaScript dashboards for demos

- **Veterinary Domain**
  - Small animal practice workflows
  - Veterinary reception and phone communication
  - Clinical documentation and client education
...
- Email: `mprevilleza.hva@gmail.com`  
